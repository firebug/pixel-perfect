...
/** @lends PixelPerfectActor */
{
  ...
  updateOverlay: makeInfallible(function(overlay) {
    ...
    if (overlay.lock) {
      content.setAttributeForElement(overlay.id, "lock", "true");
    } else {
      content.removeAttributeForElement(overlay.id, "lock");
    }
  ...
  onMouseDown: function(event) {
    ...
    let content = this.draggedOverlay.content;
    content.setAttributeForElement(this.draggedOverlay.id, "drag", "true");

    Events.emit(this, "dragstart", {
      id: this.draggedOverlay.id,
    });
  ...
  onMouseMove: function(event) {
    ...
    Events.emit(this, "drag", {
      id: this.draggedOverlay.id,
      x: this.draggedOverlay.x,
      y: this.draggedOverlay.y
    });
  ...
  onMouseUp: function(event) {
    ...
    let content = this.draggedOverlay.content;
    content.removeAttributeForElement(this.draggedOverlay.id, "drag");
