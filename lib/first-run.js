...
/** @lends FirstRun */
{
  ...
  initialize: function(options) {
    ...
    // xxxHonza: Passing a DOM node to Panel.show() method is an unsupported
    // feature that will be soon replaced.
    // See: https://bugzilla.mozilla.org/show_bug.cgi?id=878877"
    // The position should be specified in the config, but (from panel.js):
    // 'The option "position" must be a SDK object registered as anchor;'
    // How to get the anchor from an existing button?
