...
/** @lends StyleEditorOverlay */
{
  ...
  applyFirebugLayout: makeInfallible(function() {
    ...
    this.popupButton.setAttribute("label", Locale.$STR("pixelPerfect.startButton.title"));
    this.popupButton.setAttribute("tooltiptext", Locale.$STR("pixelPerfect.startButton.tip"));
