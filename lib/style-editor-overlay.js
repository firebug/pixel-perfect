...
const { OverlayFront } = require("./overlay-front.js");

const XUL_NS = "http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul";

// URL of the {@InspectorActor} module. This module will be
// installed and loaded on the backend.
const actorModuleUrl = options.prefixURI + "lib/overlay-actor.js";
...
/** @lends StyleEditorOverlay */
{
  ...
  attachOverlayActor: function() {
    ...
    let config = {
      prefix: OverlayFront.prototype.typeName,
      actorClass: "OverlayActor",
      frontClass: OverlayFront,
  ...
  detachOverlayActor: function() {
    if (!this.front) {
      return resolve();
    }

    // xxxHonza: detach from the backend
  }
});
