...
/** @lends PixelPerfectPopup */
{
  ...
  createContent: function() {
    ...
    this.panel.setAttribute("label", Locale.$STR("pixelPerfect.popupPanel.title"));
  ...
  onMessage: function(msg) {
    ...
    this.postContentMessage("refresh", this.store.getJSON());
  },
  ...
  attach: function() {
    ...
    this.styleEditorOverlay.attachActor().then(front => {
      ...
      on(this.front, "position-changed", this.onPositionChanged);
  ...
  detach: function() {
    off(this.front, "position-changed", this.onPositionChanged);
  ...
  onPositionChanged: function(data) {
    ...
    try {
      ...
      TraceError.sysout("PixelPerfectPopup.onPositionChanged; ERROR " +
        err, err);
    }
