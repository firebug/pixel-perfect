...
/** @lends PixelPerfectPopup */
{
  ...
  createPanel: function() {
    ...
    this.stack = doc.createElementNS(XUL_NS, "stack");
    ...
    this.stack.appendChild(this.panelFrame);

    this.vbox = doc.createElementNS(XUL_NS, "vbox");
    this.vbox.setAttribute("flex", "1");
    this.vbox.setAttribute("style", "pointer-events: none;");
    this.stack.appendChild(this.vbox);

    this.spacer = doc.createElementNS(XUL_NS, "spacer");
    this.spacer.setAttribute("flex", "1");
    this.vbox.appendChild(this.spacer);

    this.box = doc.createElementNS(XUL_NS, "hbox");
    this.box.setAttribute("style", "max-height: 16px;");
    this.vbox.appendChild(this.box);

    this.spacer = doc.createElementNS(XUL_NS, "spacer");
    this.spacer.setAttribute("flex", "1");
    this.spacer.setAttribute("style", "background-color: transparent");
    this.box.appendChild(this.spacer);

    this.resizer = doc.createElementNS(XUL_NS, "resizer");
    this.resizer.setAttribute("dir", "bottomend");
    this.resizer.setAttribute("type", "window");
    this.resizer.setAttribute("style", "background: url('chrome://pixelperfect/skin/resizer.png') no-repeat;pointer-events: auto;");
